...
namespace GetCms.Models.Services
{
    ...
    {
        Task<Result> SaveAsync(Content content, string userName);
        ...
        Task<Result> MapToPage(int contentId, int pageId, bool unmap = false);
        ...
        Task<MessagingTemplate> GetEmailTemplateByIdAsync(int templateId);
    }
}
